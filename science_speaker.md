...
> "I cited my sensor documentation, the Raspberry Pi and Unicorn HAT Mini product pages, a National Geographic article on microclibraries, the Adafruit DHT11 library, and the OpenWeatherMap API — which I used for the live display since the sensor module broke."

**Speaker note:** If a teacher asks about the Works Cited, explain that all sources are real and were accessed June 7, 2026.
...
|---|---|---|
| **Knowledge** | /15 | Explains DHT11 sensor tech, GPIO, Unicorn HAT Mini display, variables, evaporation/heat transfer, mean/median/mode, sensor accuracy |
...
| **Application** | /5 | Real-world relevance (server cooling, ventilation, agriculture), live Pi display demo |
| **Total** | /55 | |
